...
float scene(float3 position){
    ...
    position /=2;
    sphere += (sin(20*position.x)*sin(20*position.y * (_CosTime.r-1.5)*0.6*sin(20*position.z +((_SinTime.g-1.5)*0.2) )))*0.2;
